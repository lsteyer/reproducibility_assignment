...
```{r}
# Comparing color report accuracy of surprise vs. first control trials 
t.test(data1a$X0.2[data1a$X1.1==156], data1a$X0.2[data1a$X1.1==157])

# Comparing identity report accuracy of surprise vs. first control trials 
t.test(data1a$X0.3[data1a$X1.1==156], data1a$X0.3[data1a$X1.1==157])

chisq.test(data1a$X0.2[data1a$X1.1==156], data1a$X0.2[data1a$X1.1==157], correct = FALSE)
```
...
This reproducibility check can be considered a success, as all of the key target outcomes in the original paper were reproduced. The only target outcome not able to be reproduced was the authors' claim that...
